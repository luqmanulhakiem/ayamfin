        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex flex-column flex-md-row justify-content-md-between align-items-center">
                    <h6>Aset</h6>
                    <a href="{{ route('aset.create') }}" class="btn btn-sm btn-primary">Tambah Aset</a>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $item->asset_type }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">
                                                            {{ \Carbon\Carbon::parse($item->acquisition_date)->format('j F Y') }}
                                                        </h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        ...
                                                        <h6 class="mb-0 text-sm"><x-currency-formatter
                                                                amount="{{ $item->acquisition_cost }}" /></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $item->estimated_useful_life_years }}
                                                            Tahun
                                                        </h6>
                                                    </div>
                                                </div>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('aset.edit', ['aset' => $item]) }}" type="button"
                                                ...
                                                <a href="{{ route('aset.destroy', ['aset' => $item]) }}" type="button"
                                                    class="badge bg-danger" data-confirm-delete="true">
                                                    <svg width='16px' height="16px" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 640 640"><!--!Font Awesome Free v7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                                        <path
