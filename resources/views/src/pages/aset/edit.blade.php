                    ...
                    <form action="{{ route('aset.update', ['aset' => $aset]) }}" method="POST" id="categoryForm">
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" name="acquisition_date" type="date"
                                ...
                                class="form-control" placeholder="Cth: 100.000" required>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="name" name="acquisition_cost" type="number" class="form-control"
                                    placeholder="Cth: 100.000" value="{{ $aset->acquisition_cost }}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input id="name" name="estimated_useful_life_years" type="number" class="form-control"
                                placeholder="Cth: 1 yang dianggap 1 Tahun" value="{{ $aset->estimated_useful_life_years }}"
                                required>
                        </div>
                        <div class="form-group">
                            <label for="name">Deskripsi</label>
                            <textarea id="name" name="description" type="text" class="form-control" value="{{ $aset->description }}"
                                placeholder="masukkan deskripsi aset"></textarea>
                        </div>
